...
import { bookRideApi } from "./HomeAPI.js";
export const Home = () => {
    ...
    const handlePayNow = useCallback( async() => {
        ...
        const paymentInfo = {
            ...
            expiryDate: userInputs.expiryDate,
            cvv: userInputs.cvv,
            cardHolderName: userInputs.cardHolderName
        }
    ...
    }, [handleCardNumberChange, handleExpiryChange, handleCVVChange, isValid, userInputs, handlePayNow, paymentStatus]);
